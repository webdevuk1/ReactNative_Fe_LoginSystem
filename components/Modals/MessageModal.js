...
// border shadow on android we have to use the elevation property.
// border shadow on ios  we have use the shadow property's.
    ...
    <Modal animationType="slide" visible={modalVisible} transparent={true}>
      <ModalPressableContainer onPress={buttonHandler}>
        <ModalView>
          ...
          <RegularText style={{ marginBottom: 20 }}>{modalMessage}</RegularText>
